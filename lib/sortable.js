...
Sortable = (function(superClass) {
  ...
  Sortable.prototype._bind = function() {
    this.dragdrop.on('dragstart', (function(_this) {
      return function(e, dragging, helper, placeholder) {
        _this.placeholder = $(placeholder);
        return _this.trigger('sortstart');
      };
    })(this));
    this.dragdrop.on('dragenter', (function(_this) {
      return function(e, $dragging, $target) {
        if (_this.placeholder.prevAll().filter($target).length) {
          return _this.placeholder.insertBefore($target);
        } else {
          return _this.placeholder.insertAfter($target);
        }
      };
    })(this));
    this.dragdrop.on('before-dragend', (function(_this) {
      return function(e, $dragging) {
        return _this.placeholder.replaceWith($dragging);
      };
    })(this));
